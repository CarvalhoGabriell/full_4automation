...
Funcionalidade: Cadastro de filmes 
    Para que eu possa disponibilizar novos títulos ao catálogo
    Sendo um gestor de catálogo 
    Posso cadastrar um nono filmes.
    ...
    Esquema do Cenario: Novo filme 
        ...
        Quando faço o cadastro deste filme
    ...
    Esquema do Cenario: Campos obrigatórios
        O gestor de catálogo tenta cadastrar um novo filme, mas esquece de preencher
        um dos campos obrigatórios, em seguida, o sistema exibe uma notificação
        ao usuario.
    ...
    @doble_movie
    Cenario: Duplicado
        O gestor de catálogo tenta cadastrar um novo filme, porém o títulos
        já foi cadastrado em outro momento e o sistema informa ao usário 
